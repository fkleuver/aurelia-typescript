System.register(["aurelia-route-recognizer", "./nav-model", "./navigation-instruction", "./router-configuration", "./util"], function (exports_1, context_1) {
    "use strict";
    ...
    var aurelia_route_recognizer_1, nav_model_1, navigation_instruction_1, router_configuration_1, util_1, Router;
    return {
        setters: [
            function (aurelia_route_recognizer_1_1) {
                aurelia_route_recognizer_1 = aurelia_route_recognizer_1_1;
            },
            function (nav_model_1_1) {
                nav_model_1 = nav_model_1_1;
            },
            function (navigation_instruction_1_1) {
                navigation_instruction_1 = navigation_instruction_1_1;
            },
            function (router_configuration_1_1) {
                router_configuration_1 = router_configuration_1_1;
            },
            function (util_1_1) {
                util_1 = util_1_1;
            }
        ...
        execute: function () {
            ...
            Router = class Router {
                ...
                reset() {
                    ...
                    this._recognizer = new aurelia_route_recognizer_1.RouteRecognizer();
                    this._childRecognizer = new aurelia_route_recognizer_1.RouteRecognizer();
                ...
                configure(callbackOrConfig) {
                    return __awaiter(this, void 0, void 0, function* () {
                        ...
                        if (typeof callbackOrConfig === "function") {
                            config = new router_configuration_1.RouterConfiguration();
                            result = callbackOrConfig(config);
                        }
                        const c = yield Promise.resolve(result);
                ...
                navigate(fragment, options) {
                    ...
                    return this.history.navigate(util_1._resolveUrl(fragment, this.baseUrl, this.history._hasPushState), options);
                }
                /**
                ...
                generate(name, params, options = {}) {
                    ...
                    const rootedPath = util_1._createRootedPath(path, this.baseUrl, this.history._hasPushState, options.absolute);
                ...
                createNavModel(config) {
                    const navModel = new nav_model_1.NavModel(this, ("href" in config ? config.href : config.route));
                ...
                handleUnknownRoutes(config) {
                    ...
                    this.catchAllHandler = (instruction) => __awaiter(this, void 0, void 0, function* () {
                        instruction.config = yield this._createRouteConfig(config, instruction);
                        return instruction;
                    });
                }
                /**
                ...
                refreshNavigation() {
                    ...
                    for (const nav of this.navigation) {
                        ...
                        if (!config.href) {
                            nav.href = util_1._createRootedPath(nav.relativeHref, this.baseUrl, history._hasPushState);
                        }
                        else {
                            nav.href = util_1._normalizeAbsolutePath(config.href, history._hasPushState);
                        }
                    }
                }
                /**
                ...
                _createNavigationInstruction(url = "", parentInstruction = null) {
                    ...
                    if (results && results.length) {
                        ...
                        const instruction = new navigation_instruction_1.NavigationInstruction(Object.assign({}, instructionInit, { params: first.params, queryParams: first.queryParams || results.queryParams, config: first.config || first.handler }));
                        ...
                        const instruction = new navigation_instruction_1.NavigationInstruction(Object.assign({}, instructionInit, { params: { path: fragment }, queryParams: results ? results.queryParams : {}, config: null // config will be created by the catchAllHandler
                         }));
