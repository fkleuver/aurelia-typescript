...
describe("NavigationInstruction", () => {
  ...
  describe("getBaseUrl()", () => {
    ...
    it("should return the raw fragment when no params exist", done => {
      router._createNavigationInstruction(parentRouteName).then((instruction: any) => {
    ...
    describe("when a uri contains spaces", () => {
      it("should handle an encoded uri", done => {
        router._createNavigationInstruction("parent/parent%201").then((instruction: any) => {
      ...
      it("should encode the uri", done => {
        router._createNavigationInstruction("parent/parent 1").then((instruction: any) => {
          expect(instruction.getBaseUrl()).toBe("parent/parent%201");
          done();
        });
      });
      ...
      it("should identify encoded fragments", done => {
        router._createNavigationInstruction("parent/parent%201/child/child%201").then((instruction: any) => {
          expect(instruction.getBaseUrl()).toBe("parent/parent%201/");
          done();
        });
      });
      ...
      it("should identify fragments and encode them", done => {
        router._createNavigationInstruction("parent/parent 1/child/child 1").then((instruction: any) => {
          expect(instruction.getBaseUrl()).toBe("parent/parent%201/");
          done();
        });
      });
    ...
    describe("when using an empty parent route", () => {
      it("should return the non-empty matching parent route", done => {
        router._createNavigationInstruction("").then((parentInstruction: any) => {
          router.currentInstruction = parentInstruction;
          router._refreshBaseUrl();
          child._createNavigationInstruction(childRouteName).then((instruction: any) => {
    ...
    describe("when using an named parent route", () => {
      it("should return the non-empty matching parent route", done => {
        router._createNavigationInstruction(parentRouteName).then((parentInstruction: any) => {
          router.currentInstruction = parentInstruction;
          router._refreshBaseUrl();
          child._createNavigationInstruction(childRouteName).then((instruction: any) => {
            child._refreshBaseUrl();
