System.register(["./navigation-plan"], function (exports_1, context_1) {
    ...
    var navigation_plan_1, CommitChangesStep, NavigationInstruction;
    return {
        setters: [
        ...
        execute: function () {
            CommitChangesStep = class CommitChangesStep {
             ...
             */
            NavigationInstruction = class NavigationInstruction {
                constructor(init) {
                    this.plan = null;
                    this.options = {};
