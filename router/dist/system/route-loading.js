System.register(["./navigation-plan"], function (exports_1, context_1) {
    "use strict";
    ...
    function loadRoute(routeLoader, navigationInstruction, viewPortPlan) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (childRouter) {
                ...
                const childPlan = yield navigation_plan_1._buildNavigationPlan(childInstruction);
    ...
    var navigation_plan_1, RouteLoader, LoadRouteStep;
    return {
        setters: [
        ...
        execute: function () {
            ...
            LoadRouteStep = class LoadRouteStep {
                static get inject() {
                    return [RouteLoader];
                }
